         ...
         <div class="col-md-6">
             ...
             <?php 
               ...
               // $query = "SELECT Channel.names as ch_names,Channel.ch_id as ch_id FROM (SELECT ch_id FROM user_channels WHERE user_id = ".$_SESSION['user_id']." ) as UserChannel INNER JOIN channel_table as Channel ON UserChannel.ch_id = Channel.ch_id";
                 $query = "SELECT DISTINCT(device_group) AS device_group FROM enterprise_device_list";
                ...
                ?>
              <option value="<?php echo $row["device_group"]; ?>" ><?php echo $row["device_group"]; ?></option>
              <?php
            }
            ?>
            </select>
...
//           }
  ...
  function AddEnterpriseMacAddress()
  {
      ...
      var group_name = document.getElementById('enterprise_group_name').value;
      ...
      var datastring = {}
          ...
          datastring['device_group'] = group_name;
          datastring['status'] = 0;
 ...
 console.log("SdfsdfS"+JSON.stringify(list));
    ...
    for(var i=0;i<totalen;i++)
    {
      ...
      var newRows = "<div id='enterprise_list_"+record.mac+"'>";
        ...
        if(display_group==record.device_group){
