...
if( isset($_SESSION['user_id']) ){
  ...
  if(isset($_COOKIE[$cookie_name])) 
  {
      ...
      }elseif ($_COOKIE[$cookie_name]=="Local") {
 ...
 <div class="underlined-title">
  <div class="editContent">
   ...
   <div class="rows">
    ...
    <div class="col-md-4">
       <h4 class="latestitems" style="text-align: center;">Select Channel(s):</h4>
    </div>
  </div>
  </div>
...
$('#default_Channel').change(function(){
  ...
  function SelectScreen(name)
  {
    ...
    }else 
    {
        ...
        if(name=="Image")
        {
          window.location.href = url+"image.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="Video")
        {
          window.location.href = url+"video.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="Text")
        {
           window.location.href = url+"text.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="File")
        {
           window.location.href = url+"file.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="Url")
        {
           window.location.href = url+"url.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";
  ...
  function multiscreen(name)
  {
    ...
    }else 
    {
        ...
        if(name=="template1")
        {
          window.location.href = url+"template1.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="template2")
        {
          window.location.href = url+"template2.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="template3")
        {
           window.location.href = url+"template3.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }else if(name=="template4")
        {
           window.location.href = url+"template4.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }
        else if(name=="template5")
        {
           window.location.href = url+"template5.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }
        else if(name=="template6")
        {
           window.location.href = url+"template6.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";

        }
        else if(name=="template7")
        {
           window.location.href = url+"template7.php?screen='"+JSON.stringify(arrayGlobal)+"'&mode='near_by' ";
