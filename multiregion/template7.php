...
<div class="container toparea" >
  <div class="underlined-title">
    <div class="editContent">
      <h1 class="text-center latestitems">TEMPLATE 7</h1><span class="btn btn-warning" style="float:right;margin-bottom: 10px;" onclick="javascript:location.reload();" >Clear</span>
    </div>
  </div>
    <div class="rows">      
      ...
      <!--  <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain'  onclick="showmedia('r1');" /> -->
      <iframe id="region1" src="../images/plus55.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        <textarea id="textregion1" style="display: none;width: 100%;height: 300px;" disabled></textarea>
      </div>
    </div>
    
    <div class="col-md-6" style="padding:0px;margin:0px;">
      <div style="border:2px solid black;height:300px;">
        <!-- <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain' onclick="showmedia('r2');" /> -->
        <iframe id="region2" src="../images/plus55.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        <textarea id="textregion2" style="display: none;width: 100%;height: 300px;" disabled></textarea>
      </div>
    </div>
        ...
        <div class="col-md-6" style="padding:0px;margin:0px;">
      <div style="border:2px solid black;height:300px;">
        <!-- <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain' onclick="showmedia('r3');" /> -->
        <iframe id="region3" src="../images/plus55.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        <textarea id="textregion3" style="display: none;width: 100%;height: 300px;" disabled></textarea>
      </div>
    </div>
    
    <div class="col-md-6" style="padding:0px;margin:0px;">
      <div style="border:2px solid black;height:300px;">
       <!--  <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain' onclick="showmedia('r4');" /> -->
       <iframe id="region4" src="../images/plus55.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        <textarea id="textregion4" style="display: none;width: 100%;height: 300px;" disabled></textarea>
      </div>
    </div>
      <center>
...
<script src="../js/jscolor.js"></script>
 ...
 <script type="text/javascript">
    ...
    var regions1 = document.getElementById("region1").src;
     ...
     var regions3 = document.getElementById("region3").src;
     var regions33 = document.getElementById("textregion3").value;
     var regions4 = document.getElementById("region4").src;
     var regions44 = document.getElementById("textregion4").value;

     console.log(regions1+" "+regions11);

     if(regions1=="http://localhost/smweb/images/plus55.png" && regions11==""){
      swal("please select region 1");
     }else if(regions2=="http://localhost/smweb/images/plus55.png" && regions22==""){
      swal("please select region 2");
     }else if(regions3=="http://localhost/smweb/images/plus55.png" && regions33==""){
      swal("please select region 3");
    }else if(regions4=="http://localhost/smweb/images/plus55.png" && regions44==""){
      swal("please select region 4");
    }else{
...
<script>
  ...
  var multidatastring3;
  var multidatastring4;
...
<script type="text/javascript">
  ...
  //image
   ...
   var imagefile_new_name3;
   var imagefile_new_name4;
...
function MultiSubmit(screenmode)
{
  ...
  console.log(videopath1+"path"+videopath2+"path"+videopath3+"path"+videopath4);
  console.log(imagepath1+"path"+imagepath2+"path"+imagepath3+"path"+imagepath4);
...
if(multidatastring1==undefined || multidatastring1==null || multidatastring1==""){
    ...
    var datastring1 = {"type":"Image","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring2==undefined || multidatastring2==null || multidatastring2==""){
  ...
  var datastring2 = {"type":"Image","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring3==undefined || multidatastring3==null || multidatastring3==""){

   
  var datastring3 = {"type":"Image","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};

   var data3 = JSON.stringify(datastring3);

}else{

   var data3 = JSON.stringify(multidatastring3);

  
}

if(multidatastring4==undefined || multidatastring4==null || multidatastring4==""){

   
  var datastring4 = {"type":"Image","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};

   var data4 = JSON.stringify(datastring4);

}else{

   var data4 = JSON.stringify(multidatastring4);

  
}

      console.log(data1+"content array"+data2+"content array"+data3+"content array"+data4);
          ...
          var form_data = new FormData();     
           form_data.append('regions_count',4);  
            ...
            form_data.append('fileName3',videopath3);
            form_data.append('fileName4',videopath4);
            form_data.append('videodurationfileName1',file_new_name1);
            form_data.append('videodurationfileName2',file_new_name2);
            form_data.append('videodurationfileName3',file_new_name3);
            form_data.append('videodurationfileName4',file_new_name4);
            form_data.append('imagefileName1',imagepath1);
            form_data.append('imagefileName2',imagepath2);
            form_data.append('imagefileName3',imagepath3);
            form_data.append('imagefileName4',imagepath4);
            form_data.append('imagedurationfileName1',imagefile_new_name1);
            form_data.append('imagedurationfileName2',imagefile_new_name2);
            form_data.append('imagedurationfileName3',imagefile_new_name3);
            form_data.append('imagedurationfileName4',imagefile_new_name4);
...
function multicontent(type) {
  ...
  if(type=="URL"){
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Url","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r2'){
       document.getElementById("region2").src = urlmedianame;
      multidatastring2 = {"type":"Url","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r3'){
       document.getElementById("region3").src = urlmedianame;
      multidatastring3 = {"type":"Url","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r4'){
       document.getElementById("region4").src = urlmedianame;
      multidatastring4 = {"type":"Url","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
     ...
     $('#pushurl').modal('hide');
      ...
      var multicontentdata3 = JSON.stringify(multidatastring3);
       var multicontentdata4 = JSON.stringify(multidatastring4);
      console.log(multicontentdata1);
      console.log(multicontentdata2);
       console.log(multicontentdata3);
       console.log(multicontentdata4);
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"text","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data1};
    }
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"text","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data2};
    }
     if(regionvalue=='r3'){

       $('#region3').hide();
      $('#textregion3').show();
      document.getElementById("textregion3").innerHTML = textmedia_name;
      document.getElementById("textregion3").style.color = text_color;
      document.getElementById("textregion3").style.backgroundColor = text_background;
    
      if(text_alignment=="5"){
         document.getElementById("textregion3").style.textAlign = "right";
      }else if(text_alignment=="17"){
         document.getElementById("textregion3").style.textAlign = "center";
      }else{
        document.getElementById("textregion3").style.textAlign = "left";
      }
      
      var textsizes= text_size+"px";
      document.getElementById("textregion3").style.fontSize = textsizes;

      var data3 = ({ "textBgColor":text_background,"textColor":text_color,"textSize":Number(text_size),"isScrollAnim":false,"textAlignment":Number(text_alignment)});

      multidatastring3 = {"type":"text","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data3};
    }
    if(regionvalue=='r4'){

       $('#region4').hide();
      $('#textregion4').show();
      document.getElementById("textregion4").innerHTML = textmedia_name;
      document.getElementById("textregion4").style.color = text_color;
      document.getElementById("textregion4").style.backgroundColor = text_background;
    
      if(text_alignment=="5"){
         document.getElementById("textregion4").style.textAlign = "right";
      }else if(text_alignment=="17"){
         document.getElementById("textregion4").style.textAlign = "center";
      }else{
        document.getElementById("textregion4").style.textAlign = "left";
      }
      
      var textsizes= text_size+"px";
      document.getElementById("textregion4").style.fontSize = textsizes;

       var data4 = ({ "textBgColor":text_background,"textColor":text_color,"textSize":Number(text_size),"isScrollAnim":false,"textAlignment":Number(text_alignment)});

      multidatastring4 = {"type":"text","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data4};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Video","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Video","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r3'){
        ...
        if(videofile_name==undefined || videofile_name==null )
          ...
          console.log("file name3"+videofile_name);
           file_new_name3 = file_new_name;
           videopath3 =videofile_name;

           var iframe = document.getElementById("region3");
                  iframe.src = videotmppath;

       var data3 = ({"isStretch":true,"volume":100});

      multidatastring3 = {"type":"Video","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data3};
    }
     ...
     if(regionvalue=='r4'){
        ...
        if(videofile_name==undefined || videofile_name==null )
          ...
          console.log("file name3"+videofile_name);
           file_new_name4 = file_new_name;
           videopath4 =videofile_name;

           var iframe = document.getElementById("region4");
                  iframe.src = videotmppath;

       var data4 = ({"isStretch":true,"volume":100});

      multidatastring4 = {"type":"Video","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data4};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Image","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Image","width":50,"height":50,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
     ...
     if(regionvalue=='r3'){
         ...
         if(file_name==undefined || file_name==null )
          ...
          console.log("file name3"+file_name);
           
           imagepath3 =file_name;
           imagefile_new_name3= file_new_name;

           document.getElementById("region3").src = imagetmppath;

       var data3 = ({"scaleType":"fillScreen"});

      multidatastring3 = {"type":"Image","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data3};
    }
     ...
     if(regionvalue=='r4'){
         ...
         if(file_name==undefined || file_name==null )
          ...
          console.log("file name3"+file_name);
           ...
           imagepath4 = file_name;
           imagefile_new_name4 = file_new_name;

           document.getElementById("region4").src = imagetmppath;

       var data4 = ({"scaleType":"fillScreen"});

      multidatastring4 = {"type":"Image","width":50,"height":50,"top_margin":50,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data4};
    }
