...
<div class="container toparea" >
  <div class="underlined-title">
    <div class="editContent">
      <h1 class="text-center latestitems">TEMPLATE 5</h1><span class="btn btn-warning" style="float:right;margin-bottom: 10px;" onclick="javascript:location.reload();" >Clear</span>
    </div>
  </div>
    <div class="rows">      
...
<div class="col-md-12" >
      ...
      <div style="border: 2px solid black;height:80px;">
       <!-- <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain'  onclick="showmedia('r1');" /> -->
        <iframe id="region1" src="../images/plus22.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        <textarea id="textregion1" style="display: none;width: 100%;height: 80px;" disabled></textarea>
      </div>
...
<script src="../js/jscolor.js"></script>
 ...
 <script type="text/javascript">
    ...
    var regions1 = document.getElementById("region1").src;
     ...
     if(regions1=="http://localhost/smweb/images/plus22.png" && regions11==""){
...
function MultiSubmit(screenmode)
{
  ...
  var regionid = document.getElementById('regionid').value;
   ...
   console.log(videopath1+"path"+videopath2+"path"+videopath3);
   console.log(imagepath1+"path"+imagepath2+"path"+imagepath3);
...
if(multidatastring1==undefined || multidatastring1==null || multidatastring1==""){
    ...
    var datastring1 = {"type":"Image","width":100,"height":10,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring2==undefined || multidatastring2==null || multidatastring2==""){
  ...
  var datastring2 = {"type":"Image","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring3==undefined || multidatastring3==null || multidatastring3==""){
  ...
  var datastring3 = {"type":"Image","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
   ...
   var data3 = JSON.stringify(multidatastring3);
      ...
      console.log(data1+"content array"+data2+"content array"+data3);

        ajaxindicatorstart("<img src='../images/ajax-loader.gif'><br/>File transfer in progress<br/> Please wait...");

          var form_data = new FormData();     
           form_data.append('regions_count',3);  
...
function multicontent(type) {
  ...
  if(type=="URL"){
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Url","width":100,"height":10,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r2'){
       document.getElementById("region2").src = urlmedianame;
      multidatastring2 = {"type":"Url","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r3'){
      document.getElementById("region3").src = urlmedianame;
      multidatastring3 = {"type":"Url","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"text","width":100,"height":10,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data1};
    }
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"text","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data2};
    }
     if(regionvalue=='r3'){
      ...
      multidatastring3 = {"type":"text","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data3};
    }
...
console.log(multicontentdata3);
  document.getElementById('textmedia_name').value="";
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Video","width":100,"height":10,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Video","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r3'){
      ...
      multidatastring3 = {"type":"Video","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data3};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Image","width":100,"height":10,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Image","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
     ...
     if(regionvalue=='r3'){
      ...
      multidatastring3 = {"type":"Image","width":50,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data3};
    }
