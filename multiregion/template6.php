...
<div class="container toparea" >
  <div class="underlined-title">
    <div class="editContent">
      <h1 class="text-center latestitems">TEMPLATE 6</h1><span class="btn btn-warning" style="float:right;margin-bottom: 10px;" onclick="javascript:location.reload();" >Clear</span>
    </div>
  </div>
    <div class="rows">
      ...
      <div style="border: 2px solid black;height:300px;">
       <!--  <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain' onclick="showmedia('r2');" /> -->
        <iframe id="region2" src="../images/plus11.png" style='height: 100%; width: 100%; object-fit: fill' seamless></iframe>
...
<script type="text/javascript">
  ...
  function validation(){
    var regions1 = document.getElementById("region1").src;
     ...
     }else if(regions2=="http://localhost/smweb/images/plus11.png" && regions22==""){
...
if(multidatastring1==undefined || multidatastring1==null || multidatastring1==""){
   ...
   var data1 = JSON.stringify(datastring1);
    ...
    if(multidatastring2==undefined || multidatastring2==null || multidatastring2==""){
      ...
      var datastring2 = {"type":"Image","width":100,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
function multicontent(type) {
  ...
  if(type=="URL"){
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Url","width":100,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"text","width":100,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Video","width":100,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Image","width":100,"height":90,"top_margin":10,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
