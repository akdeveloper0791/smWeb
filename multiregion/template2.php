...
<div class="container toparea" >
  <div class="underlined-title">
    <div class="editContent">
      <h1 class="text-center latestitems">TEMPLATE 2</h1><span class="btn btn-warning" style="float:right;margin-bottom: 10px;" onclick="javascript:location.reload();" >Clear</span>
    </div>
  </div>
    <div class="rows">
      <div class="col-md-12">
      ...
      <div style="border:2px solid black;height:350px;">
        <!-- <img src="../images/plus.png" style='height: 100%; width: 100%; object-fit: contain'  onclick="showmedia('r1');" /> -->
        <iframe id="region1" src="../images/plus33.png" style='height:100%;width:100%;object-fit: fill' ></iframe>
        <textarea id="textregion1" style="display: none;width: 100%;height: 350px;" disabled></textarea>
      </div>
    </div>
      ...
      <iframe id="region2" src="../images/plus33.png" style='height: 100%; width: 100%; object-fit: fill' seamless></iframe>
         <textarea id="textregion2" style="display: none;width: 100%;height: 350px;" disabled></textarea>
      </div>
    </div>
...
<script type="text/javascript">
  function validation(){
    var regions1 = document.getElementById("region1").src;
     ...
     if(regions1=="http://localhost/smweb/images/plus33.png" && regions11==""){
      swal("please select region 1");
     }else if(regions2=="http://localhost/smweb/images/plus33.png" && regions22==""){
...
if(multidatastring1==undefined || multidatastring1==null || multidatastring1==""){
    ...
    var datastring1 = {"type":"Image","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring2==undefined || multidatastring2==null || multidatastring2==""){
  ...
  var datastring2 = {"type":"Image","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
function multicontent(type) {
  ...
  if(type=="URL"){
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Url","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r2'){
       document.getElementById("region2").src = urlmedianame;
      multidatastring2 = {"type":"Url","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"text","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data1};
    }
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"text","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Video","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Video","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Image","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Image","width":50,"height":100,"top_margin":0,"bottom_margin":0,"left_margin":50,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
