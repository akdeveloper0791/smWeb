...
<div class="container toparea" >
  <div class="underlined-title">
    <div class="editContent">
      <h1 class="text-center latestitems">TEMPLATE 1</h1><span class="btn btn-warning" style="float:right;margin-bottom: 10px;" onclick="javascript:location.reload();" >Clear</span>
    </div>
  </div>
  	...
  	<div class="rows">
        ...
        <iframe id="region1" src="../images/plus11.png" style='height:100%;width:100%;object-fit: fill' >Please click here to select content</iframe>
        ...
        <iframe id="region2" src="../images/plus22.png" style='height: 100%; width: 100%; object-fit: fill' seamless></iframe>
         <textarea id="textregion2" style="display: none;width: 100%;height: 80px;" disabled></textarea>
 ...
 <!-- <img id="imagepreview" src="" width="200" style="display:none;" /> -->
	</div>
</div>
</section>
          ...
          <!-- <form class="feedback" name="feedback"> -->
              ...
              <div class="col-md-6" style="padding-left:0px;padding-right:0px;">
                 <div class="form-group">
                    ...
                    <input type="number" class="form-control" value="10" placeholder="Enter Duration(Sec)" name="duration" id="file_duration">
                  </div> 
                   </div>
 ...
 <script type="text/javascript">
  ...
  function validation(){
    var regions1 = document.getElementById("region1").src;
     ...
     if(regions1=="http://localhost/smweb/images/plus11.png" && regions11==""){
      swal("please select region 1");
     }else if(regions2=="http://localhost/smweb/images/plus22.png" && regions22==""){
...
<script type="text/javascript">
  ...
  $('#imagename').change( function(event) {
    ...
    console.log("image path"+imagetmppath);
...
if(multidatastring1==undefined || multidatastring1==null || multidatastring1==""){
    ...
    var datastring1 = {"type":"Image","width":100,"height":90,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
...
if(multidatastring2==undefined || multidatastring2==null || multidatastring2==""){
  var datastring2 = {"type":"Image","width":100,"height":10,"top_margin":90,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":"default",'is_self_path':false,'properties':properties1};
  ...
  // if( datastring1==""|| datastring2==""|| datastring1==undefined|| datastring2==undefined){
...
function multicontent(type) {
  ...
  if(type=="URL"){
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Url","width":100,"height":90,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    if(regionvalue=='r2'){
      document.getElementById("region2").src = urlmedianame;
      multidatastring2 = {"type":"Url","width":100,"height":10,"top_margin":90,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":urlmedianame,"is_self_path":false};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"text","width":100,"height":90,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data1};
    }
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"text","width":100,"height":10,"top_margin":90,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":textmedia_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Video","width":100,"height":90,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Video","width":100,"height":10,"top_margin":90,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
    ...
    if(regionvalue=='r1'){
      ...
      multidatastring1 = {"type":"Image","width":100,"height":90,"top_margin":0,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data1};
    ...
    if(regionvalue=='r2'){
      ...
      multidatastring2 = {"type":"Image","width":100,"height":10,"top_margin":90,"bottom_margin":0,"left_margin":0,"right_margin":0,"media_name":file_new_name,"is_self_path":false,"properties":data2};
    }
