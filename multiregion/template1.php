  ...
  <div class="underlined-title">
    <div class="editContent">
     ...
     <!-- 	<div style="border: 2px solid black;height:80px;"> -->
      <div class="wrap1">
        <iframe class="frame1" id="region2" src="../images/plus444.png"></iframe>
         <textarea class="frame1" id="textregion2" style="display: none;" disabled></textarea>
       </div>
...
{
 console.log(screenmode+"paths"+path);
